...
module.exports = class About extends Command {
  ...
  async execute (meiko, content, context) {
    ...
    const embed = new meiko.Discord.MessageEmbed()
      ...
      .addField('Text Channels', client.channels.cache.filter(c => c.type === 'text').size, true)
      .addField('Voice Channels', client.channels.cache.filter(c => c.type === 'voice').size, true)
